...
<?php echo $this->Form->create('Docente'); ?>
	...
	<?php
		echo $this->Form->input('id_docente');
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Docente.id_docente')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Docente.id_docente'))); ?></li>
