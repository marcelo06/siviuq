...
<?php echo $this->Form->create('Evaluacion'); ?>
	...
	<?php
		echo $this->Form->input('id_evaluacion');
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Evaluacion.id_evaluacion')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Evaluacion.id_evaluacion'))); ?></li>
