...
<?php echo $this->Form->create('CuadroVerificacion'); ?>
	<fieldset>
		<legend><?php echo __('Edit Cuadro Verificacion'); ?></legend>
	<?php
		echo $this->Form->input('id_cuadro_verificacion');
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('CuadroVerificacion.id_cuadro_verificacion')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('CuadroVerificacion.id_cuadro_verificacion'))); ?></li>
