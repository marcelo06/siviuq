...
<?php echo $this->Form->create('LineaInvestigacion'); ?>
	<fieldset>
		<legend><?php echo __('Edit Linea Investigacion'); ?></legend>
	<?php
		echo $this->Form->input('id_linea_investigacion');
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('LineaInvestigacion.id_linea_investigacion')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('LineaInvestigacion.id_linea_investigacion'))); ?></li>
