 ...
 */
	public function add() {
		...
		$docentes = $this->Proyecto->Docente->find('list');
		$administradors = $this->Proyecto->Administrador->find('list');
		$evaluacions = $this->Proyecto->Evaluacion->find('list');
		$lineaInvestigacions = $this->Proyecto->LineaInvestigacion->find('list');
		$cuadroVerificacions = $this->Proyecto->CuadroVerificacion->find('list');
		$this->set(compact('docentes', 'administradors', 'evaluacions', 'lineaInvestigacions', 'cuadroVerificacions'));
	}
